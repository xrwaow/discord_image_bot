        ...
        response = await client.post(
            ...
            json={
                ...
                "messages": [
                    {
                        "role": "user",
                        "content": ENHANCE_PROMPT_TEMPLATE.format(prompt=prompt),
                    }
                ],
            },
            timeout=30.0,
...
if not ENABLE_ENHANCE_PROMPT:
    params = [p for p in params if p.name != "enhance_prompt"]
...
if ENABLE_ENHANCE_PROMPT:
    desc_map["enhance_prompt"] = "Enhance prompt using LLM"
